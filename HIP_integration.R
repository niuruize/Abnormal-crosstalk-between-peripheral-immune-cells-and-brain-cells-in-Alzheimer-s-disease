...
head(Idents(scRNA), 5)
save(scRNA,file="HIP_snRNA.RData")
##
...
markers.to.plot <- c("RBFOX1","CAMK2A","PROX1","DCX","SNAP25","SATB2","GAD1","GAD2","GFAP","AQP4",
                     "SOX2","PAX6","VIM","PDGFRB","LPAR1","HOPX","MFGE8","NEUROD1","ASCL1","CALB1",
                     "VCAN","SOX6","PLP1","MBP",
                     "CSF1R","P2RY12","CD74","CX3CR1","DNAH9","CFAP54","FLT1","CLDN5","DCN","COL1A2","CLIC6")
...
table(Idents(scRNA), scRNA$Diagnosis)#各组不同细胞群细胞数
Cellratio <- prop.table(table(Idents(scRNA), scRNA$Diagnosis), margin = 2)#计算各组样本不同细胞群比例
